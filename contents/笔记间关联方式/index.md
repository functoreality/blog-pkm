...
* <input type="checkbox" name="fchk" id="fold189"><label for="fold189">**链接**：最明确、精准的成对关联，也是卡片盒笔记法的要点之一。建立链接时通常需要附带一些文字说明，以使该关联更加具体明确。</label>
	...
	* <input type="checkbox" name="fchk" id="fold203"><label for="fold203">建立链接时，附上一些文字描述通常会有帮助：这能帮助展现关联的背景，使其含义更丰富；简明扼要的文字也能在日后回顾笔记时提供引导。</label>
		* <input type="checkbox" name="fchk" id="fold204"><label for="fold204">Andy Matuschak 的笔记中有一篇是《优先使用经过标注的关联》（[中文翻译](https://zhuanlan.zhihu.com/p/425763923)，[英文原文](https://notes.andymatuschak.org/z7pGUpz2fQsHHUPbjThz85xXPvHwrmikAeYH4)），其中这么写道：</label>
	...
	* 另外，单靠笔记间的普通链接有时不便于重新找到特定的笔记，因此对已有内容的查找往往还会结合其他手段来完成。在这一方面，基于链接而构建的 MOC 是十分灵活的方式。
